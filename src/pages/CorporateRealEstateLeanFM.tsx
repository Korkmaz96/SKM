...
const CorporateRealEstateLeanFM = () => {
  const cluster = services.clusters.find(c => c.id === "corporate-real-estate-lean-fm")!;
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl">
                [FEHLT] – Einleitungstext zu Corporate Real Estate & Lean FM
              </p>
            </div>
          </div>
        </div>
      ...
      <ContactCTA 
        headline="CRE/FM-Prozesse optimieren?"
        description="Wir entwickeln pragmatische Konzepte für Ihr Immobilienmanagement."
      />
      <Footer />
    </div>
  );
