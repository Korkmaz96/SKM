...
const BetreiberverantwortungOrganisation = () => {
  const cluster = services.clusters.find(c => c.id === "betreiberverantwortung-organisation")!;
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl">
                [FEHLT] – Einleitungstext zu Betreiberverantwortung & Organisation
              </p>
            </div>
          </div>
        </div>
      ...
      <ContactCTA 
        headline="Betreiberpflichten strukturieren?"
        description="Wir analysieren und optimieren Ihre Betreiberverantwortung."
      />
      <Footer />
    </div>
  );
